...
public class ExportController extends HttpServlet {
    ...
    public void exporter(
            ...
            throws ServletException, IOException, InterruptedException, SVGConverterException,
            NoSuchElementException, PoolException, TimeoutException {
    ...
    public ModelAndView handleTimeoutException(Exception ex) {
        ...
        modelAndView
                .addObject(
                        "message",
                        "Timeout converting SVG, is your file this big, or maybe you have a syntax error in the " +
                                "javascript callback?");
        return modelAndView;
    }
    ...
    public ModelAndView handleInterruptedException(Exception ex) {
        ...
        modelAndView
                .addObject(
                        "message",
                        "It took too long time to process the options, no SVG is created. Make sure your javascript " +
                                "is correct");
        return modelAndView;
    }
